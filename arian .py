...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            arian
\033[1;37m Facebook:         shiab
\033[1;37m Github  :     arian
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('https://www.facebook.com/profile.php?id=100060150615622&mibextid=ZbWKwL
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SSB(allkey)
...
def cutter():
    ...
    print(" ")
    sarfraz = input('Saving Put File Name:')
    os.system('touch ' +arian)
    os.system('sort -r '+ssb+' | uniq > '+arian)
    os.system('clear')
    print(logo)
    print("Removed Successful From File: " + ssb )
    print("New File Saved:" + arian )
    print(47*'-')
    input(f"{S} Press Enter To Back SSB Menu ")
    SSB(allkey)       
